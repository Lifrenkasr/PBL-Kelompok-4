...
const char* ssid = "trimasketir";
const char* password = "keluargaatung";

// Database Configuration
const char *db_host = "localhost";
const char *db_user = "root";
const char *db_password = "";
const char *db_name = "project_pbl";

#define ENROLL_CONFIRM_TIMES 5
#define FACE_ID_SAVE_NUMBER 7
#define ENROLL_NAME_LEN 64
...
MySQL_Connection conn((Client*)&socket_server);
...
void loop() {
  ...
  if (!fb) {
    ...
    // Lanjut ke iterasi berikutnya jika tidak dapat mendapatkan frame
    continue;
  }
